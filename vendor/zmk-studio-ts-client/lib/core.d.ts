...
export interface Request {
    ...
    setPowerSettings?: SetPowerSettingsRequest | undefined;
}
export interface Response {
    getDeviceInfo?: GetDeviceInfoResponse | undefined;
    getLockState?: LockState | undefined;
    resetSettings?: boolean | undefined;
    getPowerSettings?: PowerSettingsState | undefined;
...
export interface SetPowerSettingsRequest {
...
export declare const Request: {
    ...
    create<I extends {
        ...
        setPowerSettings?: ({
            ...
            idleTimeoutMs?: number | undefined;
            sleepTimeoutMs?: number | undefined;
        } & { [K in Exclude<keyof I["setPowerSettings"], keyof SetPowerSettingsRequest>]: never; }) | undefined;
    ...
    fromPartial<I_1 extends {
        ...
        setPowerSettings?: ({
            ...
            idleTimeoutMs?: number | undefined;
            sleepTimeoutMs?: number | undefined;
        } & { [K_2 in Exclude<keyof I_1["setPowerSettings"], keyof SetPowerSettingsRequest>]: never; }) | undefined;
...
export declare const Response: {
    ...
    create<I extends {
        ...
        getPowerSettings?: ({
            ...
            idleTimeoutMs?: number | undefined;
            sleepTimeoutMs?: number | undefined;
        } & { [K_1 in Exclude<keyof I["getPowerSettings"], keyof PowerSettingsState>]: never; }) | undefined;
        setPowerSettings?: boolean | undefined;
    } & { [K_2 in Exclude<keyof I, keyof Response>]: never; }>(base?: I | undefined): Response;
    fromPartial<I_1 extends {
        getDeviceInfo?: {
            name?: string | undefined;
            serialNumber?: Uint8Array | undefined;
        ...
        getDeviceInfo?: ({
            ...
            name?: string | undefined;
            serialNumber?: Uint8Array | undefined;
        } & { [K_3 in Exclude<keyof I_1["getDeviceInfo"], keyof GetDeviceInfoResponse>]: never; }) | undefined;
        getLockState?: LockState | undefined;
        resetSettings?: boolean | undefined;
        getPowerSettings?: ({
            idleTimeoutMs?: number | undefined;
            ...
            idleTimeoutMs?: number | undefined;
            sleepTimeoutMs?: number | undefined;
        } & { [K_4 in Exclude<keyof I_1["getPowerSettings"], keyof PowerSettingsState>]: never; }) | undefined;
        setPowerSettings?: boolean | undefined;
...
export declare const PowerSettingsState: {
    encode(message: PowerSettingsState, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): PowerSettingsState;
    fromJSON(object: any): PowerSettingsState;
    toJSON(message: PowerSettingsState): unknown;
    create<I extends {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & { [K in Exclude<keyof I, keyof PowerSettingsState>]: never; }>(base?: I | undefined): PowerSettingsState;
    fromPartial<I_1 extends {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof PowerSettingsState>]: never; }>(object: I_1): PowerSettingsState;
};
export declare const SetPowerSettingsRequest: {
    encode(message: SetPowerSettingsRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): SetPowerSettingsRequest;
    fromJSON(object: any): SetPowerSettingsRequest;
    toJSON(message: SetPowerSettingsRequest): unknown;
    create<I extends {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & { [K in Exclude<keyof I, keyof SetPowerSettingsRequest>]: never; }>(base?: I | undefined): SetPowerSettingsRequest;
    fromPartial<I_1 extends {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & {
        idleTimeoutMs?: number | undefined;
        sleepTimeoutMs?: number | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof SetPowerSettingsRequest>]: never; }>(object: I_1): SetPowerSettingsRequest;
};
